            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ trans('cruds.department.title_singular') }} {{ trans('global.list') }}</h5>
                            <span>Registered {{ trans('cruds.department.title') }} with last updated on top</span>
                        </div>
                    </div>
                </div>
                @can('department_create')
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <div>
                                <a href="{{route('admin.departments.create')}}" class="btn btn-outline-info">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dt-responsive">
                            @include('admin.departments.list_table')
                        </div>
                    </div>
                </div>
            </div>
