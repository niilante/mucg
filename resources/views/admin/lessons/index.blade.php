                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>Registered Lessons with last updated on top</span>
                        </div>
                    </div>
                </div>
                @can('lesson_create')
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <div>
                                <a href="{{route('admin.lessons.create')}}" class="btn btn-outline-info">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dt-responsive">
                            @include('admin.lessons.list_table')
                        </div>
                    </div>
                </div>
            </div>
