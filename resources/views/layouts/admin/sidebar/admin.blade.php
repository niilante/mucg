    ...
    <div class="sidebar-content">
        <div class="nav-container">
            ...
            <div class="nav-lavel">{{ Auth::user()->role_name}}</div>
                ...
                <div class="nav-lavel">lessons</div>

                <div class="nav-item has-sub">
                    <a href="javascript:void(0)" class="nav-link {{ request()->is('admin/lessons') || request()->is('admin/lesson/all') ? 'active' : '' }}">
                        <i class="ik ik-layers"></i>
                        {{ trans('cruds.lesson.title') }}
                    </a>
                    <div class="submenu-content">

                        <a href="{{ route("admin.lessons.index") }}" class="menu-item {{ request()->is('admin/lessons/index') ? 'active' : '' }}">
                            <i class="ik ik-list"></i>
                            {{ trans('cruds.lesson.title') }}
                        </a>
                        <a href="{{ route("admin.lessons.create") }}" class="menu-item {{ request()->is('admin/lessons/create') ? 'active' : '' }}">
